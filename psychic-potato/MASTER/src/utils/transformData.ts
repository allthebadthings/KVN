...
export const getLayoutedElements = (nodes: Node[], edges: Edge[], direction = 'TB') => {
  ...
  // Tighter layout with reduced spacing to prevent excessive horizontal spread
  dagreGraph.setGraph({
    rankdir: direction,
    nodesep: 30,      // Horizontal spacing between nodes (reduced from default ~50)
    ranksep: 60,      // Vertical spacing between ranks (reduced from default ~50)
    marginx: 20,
    marginy: 20
  });
